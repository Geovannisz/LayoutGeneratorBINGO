...
// Transitions: Black → Green → Pink/Magenta → Red → Orange → Yellow
// As shown in SAOImageDS9 color menu
const DS9_A_MAP = [
    [0, 0, 0], [0, 8, 0], [0, 16, 0], [0, 24, 0],
    [0, 32, 0], [0, 40, 0], [0, 48, 0], [0, 56, 0],
    [0, 64, 0], [0, 72, 0], [0, 80, 0], [0, 88, 0],
    [0, 96, 0], [0, 104, 0], [0, 112, 0], [0, 120, 0],
    [0, 128, 0], [0, 136, 0], [0, 144, 0], [0, 152, 0],
    [0, 160, 0], [0, 168, 0], [0, 176, 0], [0, 184, 0],
    [32, 176, 32], [64, 160, 64], [96, 144, 96], [128, 128, 128],
    [160, 96, 128], [192, 64, 128], [224, 32, 128], [255, 0, 128],
    [255, 0, 112], [255, 0, 96], [255, 0, 80], [255, 0, 64],
    [255, 0, 48], [255, 0, 32], [255, 0, 16], [255, 0, 0],
    [255, 16, 0], [255, 32, 0], [255, 48, 0], [255, 64, 0],
    [255, 80, 0], [255, 96, 0], [255, 112, 0], [255, 128, 0],
    [255, 144, 0], [255, 160, 0], [255, 176, 0], [255, 192, 0],
    [255, 200, 0], [255, 208, 0], [255, 216, 0], [255, 224, 0],
    [255, 232, 0], [255, 240, 0], [255, 248, 0], [255, 255, 0],
